...
public class KnowledgeNodeEditorView extends javax.swing.JDialog {
    ...
    public DefaultTreeModel getTreeModel() {
        return (DefaultTreeModel) knowledgeTree.getModel();
    }

    public MyTreeNode getSourcesTreeNode() {
        return sources;
    }

    public MyTreeNode getDestinationsTreeNode() {
        return destinations;
    }

    public MyTreeNode getNeighborsTreeNode() {
        return neighbors;
    }
    ...
    public javax.swing.JButton getAddNodeButton() {
    ...
    public javax.swing.JTextField getCatagoryTextField() {
        return catagoryTextField;
    }

    public javax.swing.JTextArea getDefinitionTextArea() {
    ...
    public javax.swing.JTextPane getKnowledgeNodeInfoPane() {
        return knowledgeNodeInfoPane;
    }

    public javax.swing.JTree getKnowledgeTree() {
    ...
    public javax.swing.JButton getRemoveNodeButton() {
        return removeNodeButton;
    }

    public javax.swing.JButton getRenameRootButton() {
        return renameRootButton;
    }
    ...
    private void initComponents() {
        ...
        knowledgeNodeInfoPane.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 102, 255)));
        ...
        catagoryLabel.setForeground(new java.awt.Color(0, 51, 51));
        catagoryLabel.setText("Catagory:");

        definitionLabel.setFont(new java.awt.Font("华文细黑", 1, 14)); // NOI18N
        definitionLabel.setForeground(new java.awt.Color(0, 51, 51));
        definitionLabel.setText("Definition:");

        descriptionLabel.setFont(new java.awt.Font("华文细黑", 1, 14)); // NOI18N
        descriptionLabel.setForeground(new java.awt.Color(0, 51, 51));
        ...
        descriptionTextArea.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 102, 255)));
        ...
        definitionTextArea.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 102, 255)));
        ...
        addNodeButton.setBackground(new java.awt.Color(0, 51, 51));
        ...
        removeNodeButton.setBackground(new java.awt.Color(0, 51, 51));
        ...
        renameRootButton.setBackground(new java.awt.Color(0, 51, 51));
        ...
        jLabel5.setFont(new java.awt.Font("华文琥珀", 0, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 51, 51));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("知识点编辑器");

        editKnowledgeNodeButton.setBackground(new java.awt.Color(0, 51, 51));
        ...
        newNodeButton.setBackground(new java.awt.Color(0, 51, 51));
