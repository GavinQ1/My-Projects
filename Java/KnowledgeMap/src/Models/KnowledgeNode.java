...
public class KnowledgeNode implements Comparator<KnowledgeNode>, 
    ...
    private KnowledgeNodeList sources, destinations, neighbors;
    ...
    /*
    public KnowledgeNode cleanClone() {
        return new KnowledgeNode(name, catagory, definition, description, 
                sources.getName(), destinations.getName(), neighbors.getName());
    }
    
    public void relationClone(KnowledgeNode o) {
